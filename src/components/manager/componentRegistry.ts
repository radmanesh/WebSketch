...
/**
 * Registry mapping component types to their canvas renderers
 */
class ComponentRegistry {
  private renderers: Map<ComponentType, ICanvasRenderer> = new Map();
   ...
   */
  register(type: ComponentType, renderer: ICanvasRenderer): void {
